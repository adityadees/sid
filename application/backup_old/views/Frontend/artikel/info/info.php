<section id="page-title"  class="background-overlay-dark" data-parallax-image="">
    <div class="container">
        ...
        <div class="row">
            <div class="content col-lg-8">
                <div id="blog" class="post-thumbnails">
                    <?php if(count($info_grab)==0){ ?>
                        <div class="alert alert-info">
                            <strong>Maaf !</strong> Untuk saat ini belum ada postingan untuk halaman ini.
                        </div>
                    <?php } else { 
                        foreach($info_grab as $i) : ?>
                            <div class="post-item">
                                <div class="post-item-wrap">
                                    <div class="post-image">
                                        <a href="<?= base_url('artikel/detail/').$i->artikel_slug ?>">
                                    ...
                                    <div class="post-item-description">
                                        ...
                                        <a href="<?= base_url('artikel/detail/').$i->artikel_slug ?>" class="item-link">Read More <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; 
