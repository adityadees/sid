...
<form method="POST" action="<?= base_url()?>index.php/backend/artikel/edit" enctype="multipart/form-data"  accept-charset="utf-8">
                    ...
                    <div class="ibox-content">
                        <div class="form-group">
                            ...
                            <select name="jenis" class="form-control">
                                <option value="news" <?php if($artikel_grab[0]->artikel_jenis == 'news'){echo "selected";} else {}?>>News</option>
                                <option value="info" <?php if($artikel_grab[0]->artikel_jenis == 'info'){echo "selected";} else {}?>>Info</option>
                            </select>
                        </div>
                        <div class="form-group">
