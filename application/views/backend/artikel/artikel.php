<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
        <a href="<?= base_url()?>index.php/dash/artikel/create" class="btn btn-primary mt-4">Tambah Data</a>
    </div>
</div>
                            ...
                            <tbody>
                                ...
                                foreach($artikel_grab as $i) : $no++;
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <a href="<?= base_url();?>index.php/dash/artikel/detail/<?= $i->artikel_id; ?>">
                                                <?= $i->artikel_judul;?>
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="<?= base_url();?>index.php/dash/artikel/edit/<?= $i->artikel_id; ?>">
                                                            Edit
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item"  href="<?= base_url();?>index.php/dash/artikel/detail/<?= $i->artikel_id; ?>">
                                                            Lihat Detail
                                                        </a>
                                                    </li>
                                                </ul>
...
<?php foreach($artikel_grab as $x) : ?>
    <div class="modal inmodal" id="artikel-delete<?= $x->artikel_id ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <form action="<?= base_url() ?>index.php/dash/artikel/delete" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
