                                ...
                                <div class="col-md-12">
                                    <div class="call-to-action call-to-action-border">
                                        ...
                                        <div class="alert alert-success text-white">
                                            <a href="<?= base_url('uploads/attach/surat_pernyataan.pdf'); ?>" target="_blank"><i class="fa fa-download"></i>&nbsp;&nbsp;Download Surat Pernyataan</a>
                                        </div>

                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                <button class="btn btn-primary" data-target="#modalUKT" data-toggle="modal">
                                                    Bukti UKT / Bukti Bidikmisi
                                                </button>
                                                <p class="text-danger text-italic">
                                                    <em>- Untuk Mahasiswa <b>Bidikmisi</b> silahkan melampirkan <b>surat atau tanda bukti peserta Bidikmisi</b><br>
                                                        - Untuk Mahasiswa <b>Non-Bidikmisi</b> silahkan melampirkan <b>Bukti Pembayaran UKT terakhir</b>
                                                    </em>
                                                </p>
                                            </div>
                                            <div class="col-md-6">
                                                <button class="btn btn-primary" data-target="#modalSewa" data-toggle="modal">Bukti Pembayaran Sewa</button>
                                                <p class="text-danger text-italic">
                                                    <em>
                                                        - Bukti pembayaran sewa <b>Wajib</b> di Upload <b>Setelah melakukan Validasi</b> di Kantor BPU
                                                    </em>
                                                </p>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="alert alert-danger">
                                                              Saat ini anda tidak memiliki informasi tentang akademik. Silahkan registrasi ulang atau hubungi operator untuk informasi lebih lanjut.
                                                          </div>  
                                                      </div>
                                                  </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        foreach ($fakultas_grab as $keyf) :
                                                            if($keyf->fakultas_id == $data_user->penghuni_fakultas){
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        foreach ($jurusan_grab as $keyf) :
                                                            if($keyf->jurusan_id == $data_user->penghuni_jurusan){
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        foreach ($prodi_grab as $keyf) :
                                                            if($keyf->prodi_id == $data_user->penghuni_prodi){
                                    ...
                                    <div class="col-lg-6">
                                        <div class="call-to-action call-to-action-border">
                                            ...
                                            if(isset($data_registrasi[0])){
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <a href="<?= base_url('index.php/cetak-kartu')?>" target="_blank" class="btn btn-success"><i class="fa fa-print"></i> Cetak Kartu Sewa</a>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-9">
                                <div class="tab-content" id="myTabContent4">
                                    <div class="tab-pane fade show active" id="personal4" role="tabpanel" aria-labelledby="personal-tab">
                                        ...
                                        <form class="form-transparent-grey" action="<?= base_url('index.php/frontend/user/update');?>" method="POST" enctype="multipart/form-data"  id="personal-form">
                                            <div class="row">
                                                <div class="col-lg-12">
                                    ...
                                    <div class="tab-pane fade" id="paswrd4" role="tabpanel" aria-labelledby="paswrd-tab">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <form method="POST" action="<?= base_url('index.php/frontend/user/update')?>">
                                                    <div class="heading-text heading-line">
...
<div class="modal fade " id="modalUKT" tabindex="-1" role="modal" aria-labelledby="modal-label" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-md">
        <form action="<?= base_url('index.php/frontend/user')?>" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-40 p-t-60 p-xs-20">
                            <h4>Pembayaran UKT / Bukti Peserta Bidikmisi</h4>
                            <div class="row">
                                <div class="col-md-12">
                                    <?php if(count($struk_grab)==0) { ?>
                                        <div class="alert alert-danger fade show" role="alert">
                                            Anda belum mengupload file
                                        </div>
                                    <?php } else { if($struk_grab[0]->struk_ukt==0){ ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="alert alert-info fade show" role="alert">
                                            File anda : <a href="<?= base_url('uploads/asrama/struk/fileukt/'.$this->data['idmhs'].'/'.$struk_grab[0]->struk_ukt)?>" class="text-danger" target="_blank"> Download</a><br>
                                            <span><em>Silahkan upload ulang jika anda salah mengirim file</em></span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="fileukt" class="form-control" type="file" accept=".pdf,.jpg,.jpeg,.png" required="">
                                    </div>
                                    <div class="text-right form-group" style="margin-top:20px;">
                                        <button data-dismiss="modal" class="btn btn-outline" type="button">Close</button>
                                        <button class="btn btn-primary" type="submit" value="uploadukt" name="uploadukt">Upload</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade " id="modalSewa" tabindex="-1" role="modal" aria-labelledby="modal-label" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-md">
        <form action="<?= base_url('index.php/frontend/user')?>" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="row">
                        ...
                        <div class="p-40 p-t-60 p-xs-20">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php } else { if($struk_grab[0]->struk_sewa==0){ ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="alert alert-info fade show" role="alert">
                                            File anda : <a href="<?= base_url('uploads/asrama/struk/filesewa/'.$this->data['idmhs'].'/'.$struk_grab[0]->struk_sewa)?>" class="text-danger" target="_blank"> Download</a><br>
                                            <span><em>Silahkan upload ulang jika anda salah mengirim file</em></span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="sr-only">File</label>
                                        <input name="filesewa" class="form-control" type="file" accept=".pdf,.jpg,.jpeg,.png" required="">
                                    </div>
                                    <div class="text-right form-group" style="margin-top:20px;">
                                        <button data-dismiss="modal" class="btn btn-outline" type="button">Close</button>
                                        <button class="btn btn-primary" type="submit" value="uploadsewa" name="uploadsewa">Upload</button>
                                    </div>
                                </div>
                            </div>
                        </div>
