		...
		<div class="text-middle">
			...
			<div class="row">
				<div class="col-lg-8 center p-20 background-white b-r-6">
					<form class="form-transparent-grey" action="<?= base_url('index.php/frontend/user/create');?>" method="POST" enctype="multipart/form-data"  id="registration-form">
						<div class="row">
							<div class="col-lg-12">
							...
							<div class="col-lg-12">
								...
								<div class="row">
									...
									<div class="col-lg-6 form-group">
										...
										<input type="text" name="nim" placeholder="NIM" id="nimreg" class="form-control" data-validation="number length" data-validation-length="min10" data-validation-error-msg="NIM tidak boleh kosong (Hanya Angka), jika belum memiliki NIM silahkan gunakan nomor hp sebagai pengganti NIM untuk sementara.">
									</div>

									<div class="col-lg-6 form-group">
										<label class="sr-only">Fakultas</label>
										<select id="fakultas" name="fakultas" class="form-control"   data-validation="required" data-validation-error-msg="Silahkan pilih Fakultas">
											<option value="">-- Pilih Fakultas --</option>
											<?php foreach($gfak as $gf) :?>
												<option value="<?= $gf->fakultas_id ?>"><?= $gf->fakultas_nama ?></option>
											<?php endforeach; ?>
										</select>
										<!-- <label class="sr-only">Fakultas</label>
								...
								<div class="row">
									...
									<div class="col-lg-6 form-group">
										...
										<select name="jurusan" id="jurusan" class="form-control" data-validation="required" data-validation-error-msg="Silahkan pilih Jurusan">
									...
									<div class="col-lg-6 form-group">
										...
										<select name="prodi" id="prodi" class="form-control" data-validation="required" data-validation-error-msg="Silahkan pilih jenis Prodi">
								...
								<div class="row">
									...
									<div class="col-lg-12 form-group">
										...
										<select class="form-control" name="jm" id="selJM"  data-validation="required" data-validation-error-msg="Silahkan pilih jenis mahasiswa">
											...
											<option value="bm">Bidikmisi</option>
											<option value="nonbm">Non - Bidikmisi</option>
										</select>
									</div>
								</div>
							</div>
